...
export const projects: Project[] = [
  {
    ...
    description:
      "Sistema ERP completo para gestão de finanças, estoque e clientes.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Plataforma para administração de condomínios, com portal para síndicos e moradores.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Aplicação segura para armazenamento e gerenciamento de credenciais.",
    longDescription:
  ...
  },
  {
    ...
    title: "Landing Pages",
    description:
      "Criação de landing pages de alta conversão para diversos nichos.",
    longDescription:
  ...
  },
  {
    ...
    title: "Automação n8n",
    description:
      "Workflow de automação para integração de sistemas e processos.",
    longDescription:
