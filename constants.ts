...
export const skills: Skill[] = [
    ...
    { name: 'PHP', icon: FaPhp, color: '#777BB4', usage: 'Manutenção e modernização de sistemas legados.', level: 75 },
    ...
    { name: 'Angular', icon: FaAngular, color: '#DD0031', usage: 'Desenvolvimento de SPAs complexas para o setor corporativo.', level: 80 },
    { name: 'React', icon: FaReact, color: '#61DAFB', usage: 'Criação de UIs reativas e componentes reutilizáveis.', level: 88 },
    { name: 'Node.js', icon: FaNodeJs, color: '#339933', usage: 'Construção de microserviços e ferramentas de build.', level: 70 },
    { name: 'Docker', icon: FaDocker, color: '#2496ED', usage: 'Containerização de aplicações para garantir consistência entre ambientes.', level: 80 },
...
export const projects: Project[] = [
    ...
    },
    {
        ...
        image: 'https://picsum.photos/seed/n8n/800/600',
